...
OUTPUT_DIR="./output/mem_r1_qwen3_1.7b"

# 2. Environment & Agent Configuration
# Select the Environment
ENV_TYPE="rerank_bank" 
# Select the Agent Module
AGENT_TYPE="memory_rmm_agent"
...
python3 examples/train_mem_grpo.py \
    ...
    --wandb_name "RMM_${AGENT_TYPE}_${ENV_TYPE}_${MODEL_NAME}" \
    --epoch "$EPOCHS"